...
{
    MegoAuthenticate *auth;
    MRServerModel  *server;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
      ...
      server=[[MRServerModel alloc]init];
     [server intializeSDK];
    ...
    //******** when use in real device this code place in didRegisterForRemoteNotificationsWithDeviceToken  ********************
    
    NSString *devToken=@"kjhdfkhgkgdhlksjldsjlkdfjlkfdsjldskjdfslkdfjlkdfjldf";
