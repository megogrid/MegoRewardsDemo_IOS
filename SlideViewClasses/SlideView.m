...
@interface SlideView()
  ...
  @property(nonatomic,retain)NSMutableArray *totalItemArray;
@end
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        self.totalItemArray = [NSMutableArray arrayWithObjects:@"Campaigns",@"History",@"Send Gift",@"Receive Gift",nil];
        self.imageArray=[NSArray arrayWithObjects:@"account_icn.png",@"file_backup_icn.png",@"File_restore_icn.png",@"pre_backup_icn.png",nil];
...
{
    if( [[[NSUserDefaults standardUserDefaults] objectForKey:@"allowgifting"] isEqualToString :@"1" ])
    {
        NSString *searchString = @"Send Gift";
        [self.totalItemArray removeObject:searchString];
